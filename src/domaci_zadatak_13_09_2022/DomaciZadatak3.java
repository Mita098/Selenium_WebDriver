...
public class DomaciZadatak3 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.name("name")).sendKeys("Dimitrije Stojanovic");
		driver.findElement(By.name("department")).sendKeys("Dimitrije Stojanovic");
		driver.findElement(By.name("phone")).sendKeys("Dimitrije Stojanovic");
